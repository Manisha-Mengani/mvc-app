...
*
* @author Gangadhar Yerramsetti <s537493@nwmissouri.edu>
*
*/
...
api.get('/findone/:id', (req, res) => {
  ...
  StudentSchema.find({ _id: id }, (err, results) => {
...
api.get('/create', (req, res) => {
  ...
  StudentSchema.find({}, (err, data) => {
    ...
    res.locals.students = data
    res.locals.student = new StudentSchema()
...
api.post('/delete/:id', (req, res) => {
  ...
  StudentSchema.remove({ _id: id }).setOptions({ single: true }).exec((err, deleted) => {
    if (err) { return res.end(notfoundstring) }
